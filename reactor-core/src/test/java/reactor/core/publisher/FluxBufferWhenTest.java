...
public class FluxBufferWhenTest {
	...
	public void normal() {
		...
		assertThat(sp3.hasDownstreams()).withFailMessage("sp3 has no subscribers?").isTrue();
		...
		assertThat(sp4.hasDownstreams()).withFailMessage("sp4 has no subscribers?").isTrue();
	...
	public void startCompletes() {
		...
		assertThat(close.hasDownstreams()).withFailMessage("close has no subscribers?").isTrue();
...
//		assertThat(source.hasDownstreams()).withFailMessage("source has subscribers?").isFalse(); // FIXME
		assertThat(open.hasDownstreams()).withFailMessage("open has subscribers?").isFalse();
		assertThat(close.hasDownstreams()).withFailMessage("close has subscribers?").isFalse();
	}
